...
public abstract class MySqlDatabaseSchemaProviderBase : MariaDbFamilyDatabaseSchemaProvider
{
    ...
    // MySQL has no sequence object at all: CREATE SEQUENCE is a syntax error (measured on
    // mysql:latest). AUTO_INCREMENT is the nearest thing and is a different concept.
