...
/// <summary>
/// A canonical PostgreSQL object name made of one or more identifier segments (e.g. schema,
/// object, column). The segment logic, equality, hashing, and canonical rendering live in
/// <see cref="SqlNameBase{TSelf}"/>; this type supplies only PostgreSQL's double-quote
/// identifier quoting and the static factory entry points.
///
