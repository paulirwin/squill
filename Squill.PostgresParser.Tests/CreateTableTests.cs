...
""";
        ...
        var lastUpdateColumn = Assert.IsType<ColumnDefinition>(createTable.Elements[3]);
        ...
        nullableConstraint = Assert.IsType<NullableColumnConstraint>(lastUpdateColumn.Constraints[1]);
        Assert.False(nullableConstraint.Nullable);
    }
}