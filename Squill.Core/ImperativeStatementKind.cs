...
/// none — it sends the author to fix the wrong thing.
///
/// <para>
/// Each parser has its own copy of this distinction in its own syntax namespace, because the
/// parsers deliberately do not reference <c>Squill.Core</c>; the providers, which bridge the
/// two, map one to the other.
/// </para>
/// </summary>
public enum ImperativeStatementKind
{
    /// <summary>
